...
export default class TransactionScreen extends Component {
  ...
  handleTransaction = async () => {
    var {bookId, studentId}=this.state;//para obter os dados do documento
  ...
  //aula 73: consultas no firestorm
  ...
  //aula 73: verificando função q verifica se o aluno é elegivel para retirar o livro
